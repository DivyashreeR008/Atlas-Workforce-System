...
public class PayrollController {
    ...
    public ResponseEntity<List<PayrollRecord>> getPayrollsByEmployee(@PathVariable String employeeId) {
        return ResponseEntity.ok(service.getPayrollsByEmployeeId(employeeId));
    }
    ...
    public ResponseEntity<?> runPayroll(
        ...
        try {
            ...
            PayrollRecord record = service.runPayroll(employeeId, period, baseSalary, allowances, deductions);
